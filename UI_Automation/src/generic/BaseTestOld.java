...
public abstract class BaseTestOld  implements AutoConst 
{
	...
	{
		htmlReporter= new ExtentHtmlReporter("./Reports/TestReport_"+SystemDate.systemDate()+".html");
		...
		htmlReporter.config().setReportName("UI_Automation");
	...
	public void openApplication() throws InterruptedException
	{
		...
		driver.get("http://otbperftest1:155/");
		...
		loginpage.setuserName("arti.m");
		loginpage.setPassword("Samsung-1234");
